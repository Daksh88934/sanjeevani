...
interface Props {
  onComplete?: (bpm: number, painIndex: number) => void;
}

const TouchlessVitals = ({ onComplete }: Props) => {
    ...
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      >
        ...
        <div style={{ textAlign: "right", fontFamily: "JetBrains Mono" }}>
          <div
            style={{
              color: bpm > 0 ? "var(--status-green)" : "var(--status-red)",
              fontSize: "1.2rem",
              fontWeight: "bold",
            }}
          >
          ...
          <div style={{ color: "var(--text-muted)", fontSize: "0.8rem" }}>
            FRAME_RATE: 60 FPS | LATENCY: ~12ms
          </div>
        </div>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "1.5rem", flex: 1 }}>
          <div
            style={{
              ...
              alignItems: "center",
              boxShadow: "inset 0 0 50px rgba(0, 240, 255, 0.1)",
            }}
          >
            <video
              ref={videoRef}
              ...
              >
                ...
                <h2
                  style={{
                    ...
                    fontSize: "2rem",
                    margin: 0,
                    textShadow: "0 0 20px var(--status-red)",
                  }}
                >
                  NO HUMAN SUBJECT DETECTED
                </h2>
                <p style={{ color: "#fff", fontFamily: "JetBrains Mono", marginTop: "0.5rem" }}>
                  Please face the camera directly to initialize vitals scan.
                </p>
              </div>
            )}
          </div>
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", zIndex: 1 }}>
                <span
                  ...
                  style={{
                    ...
                    lineHeight: 1,
                    fontWeight: "bold",
                    color: bpm === 0 ? "var(--status-red)" : "#fff",
                    textShadow: bpm === 0 ? "none" : "0 0 30px var(--status-red-bg)",
                  }}
                >
                  {bpm === 0 ? "---" : bpm}
                </span>
            ...
            {!isCalibrating && progress >= 100 && (
              <div
                style={{
                  ...
                  gap: "1rem",
                  fontFamily: "JetBrains Mono",
                  boxShadow: "0 0 20px var(--status-green-bg)",
                }}
              >
                <ShieldCheck size={32} />
                <div>
                  ...
                  <div style={{ fontSize: "0.85rem", opacity: 0.8 }}>
                    Data securely transmitted to Doctor Dashboard via encrypted tunnel.
                  </div>
                </div>
              </div>
            )}
